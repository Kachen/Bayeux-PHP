...
interface SecurityPolicy
{
     ...
     */
    public function canPublish(BayeuxServer $server, ServerSession $session, ServerChannel $channel, ServerMessage $message);
     ...
     */
    public function canSubscribe(BayeuxServer $server, ServerSession $session, ServerChannel $channel, ServerMessage $message);
